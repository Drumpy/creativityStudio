      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0c1f5a] via-[#06102D] to-[#0C1F5A] flex flex-col">
        ...
        <div className="xl:container mx-auto px-4 flex flex-col flex-grow justify-center items-center text-center z-10 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-end sm:justify-center grow mb-16 sm:m-0">
            ...
            <a className="flex items-center justify-center px-6 py-3 text-[#7895ED] border border-[#7895ED] uppercase font-semibold text-xl leading-6 cursor-pointer transition-all sm:self-center">
              Contact Us
            </a>
          </div>
        </div>
        <div className="relative hidden lg:block pointer-events-none -z-0 bottom-8">
          <Marquee
            gradient={false}
            speed={80}
            className="text-[150px] text-[#0c1f5a54] leading-none uppercase whitespace-nowrap font-[Bauziet] overflow-hidden "
          >
            {servicesStr}
          </Marquee>
        </div>
